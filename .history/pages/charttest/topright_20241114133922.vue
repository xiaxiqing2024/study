...
export default {
  ...
  methods: {
    initChart() {
      ...
      const option = {
        legend: {
          data: ["Search Engine", 'Direct',"Direct(Traffic Sources)", "Marketing", "Baidu", "Email"],
        },
        series: [
          {
            ...
            data: [
              { value: 1548, name: "Search Engine",labelLine: { show: false }},
          ...
          },
          {
            ...
            data: [
              { value: 1048, name: "Baidu" ,labelLine: { show: false }},
